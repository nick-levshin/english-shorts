...
// Цвета уровней
// const levels = {
//   A1: ['#4f8cff', '#00b4ff', '#ffffff'],
//   A2: ['#00ffcc', '#0099ff', '#33cc99'],
//   B1: ['#ff6b6b', '#ff8f56', '#ffbf6b'],
//   B2: ['#b266ff', '#ff66cc', '#ff99ff'],
//   C1: ['#ffd700', '#ffdf70', '#fff4a3'],
//   C2: ['#7ad7f0', '#b6b8ff', '#e4d7ff'],
// };
...
const levels = {
  ...
  // 🔹 Яркие лаймово-зелёные (чтобы сильно отличались от всех синих)
